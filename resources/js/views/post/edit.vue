      ...
      <div class="col-md-6 mx-auto">
        <div class="form-group">
          ...
          <input
            ...
            autocomplete="off"
            class="form-control"
            :class="{'is-invalid':errors.has('title') , 'is-valid':!errors.count()   }"
          />
        ...
        <div class="form-group">
          ...
          <input
            ...
            v-model="post.body"
            class="form-control"
            :class="{'is-invalid':errors.has('body') , 'is-valid':!errors.count()   }"
          />
        ...
        <div class="form-group">
          ...
          <input
            ...
            @change="UImage($event)"
            class="form-control"
            :class="{'is-invalid':errors.has('image') , 'is-valid':!errors.count()   }"
          />
